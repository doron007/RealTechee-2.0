...
const ContactUs: NextPage = () => {
  ...
  const SuccessMessage = () => {
    ...
    return (
      <div id="contact-success-message" tabIndex={-1} className="w-full max-w-[692px] mx-auto flex flex-col gap-6 sm:gap-8 text-center px-4 sm:px-6 md:px-0 outline-none">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            <H2 className="text-[#22C55E] text-xl sm:text-2xl md:text-3xl">Message Sent Successfully!</H2>
            <P1 className="max-w-lg mx-auto text-sm sm:text-base">
              Thank you for contacting us. Our team at RealTechee will review your inquiry and get back to you within 24 hours.
            </P1>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 sm:p-6 w-full max-w-md mx-auto">
            ...
            <div className="space-y-2 text-left">
              <div className="flex items-start gap-3">
                ...
                <span className="text-green-700 text-sm">We'll review your inquiry details</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-green-600 font-bold">2.</span>
                <span className="text-green-700 text-sm">A team member will reach out to you directly</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-green-600 font-bold">3.</span>
                <span className="text-green-700 text-sm">We'll schedule a consultation if needed</span>
              </div>
            </div>
          </div>
  ...
  const ErrorMessage = () => {
    ...
    const getErrorInfo = (error: any) => {
      if (!error) return {
        type: 'general',
        message: 'Something went wrong with your message. Please try again or contact us for assistance.'
      };
        ...
        <div className="p-4 sm:p-6 bg-red-50 border border-red-200 rounded-lg">
          ...
          <div className="text-center mb-6">
            ...
            <H3 className="text-red-800 mb-2 text-lg sm:text-xl">
              {errorInfo.type === 'auth' ? 'Authentication Required' : 'Message Failed to Send'}
            </H3>
        ...
        {isSubmitting && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
            <div className="bg-white rounded-lg p-6 max-w-sm mx-4 text-center">
              ...
              <H3 className="text-gray-800 mb-2">Sending your message...</H3>
