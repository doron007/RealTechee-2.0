...
Amplify-managed tables (*-fvn7t5hbobaxjklhrqzdl4ac34-NONE format).
...
class AmplifyDataMigrator:
    def __init__(self):
        ...
        self.amplify_suffix = "-fvn7t5hbobaxjklhrqzdl4ac34-NONE"
    ...
    def convert_existing_wix_urls(self, dry_run: bool = True):
        ...
        try:
            ...
            conversion_targets = {
                'Projects-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['gallery'],
                'ProjectComments-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['files'], 
                'Quotes-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['documents', 'images']
            }
    ...
    def convert_existing_wix_documents(self, dry_run: bool = True):
        ...
        try:
            ...
            document_conversion_targets = {
                'eSignatureDocuments-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['signedDocument', 'document'],
                'Projects-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['documents', 'signedContracts'],
                'Quotes-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['document'],
                'Legal-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['content'],  # May contain embedded document URLs
                'Requests-fvn7t5hbobaxjklhrqzdl4ac34-NONE': ['uploadedDocuments']
            }
    ...
    def detect_main_table_suffix(self) -> str:
        ...
        try:
            ...
            sandbox_suffix = "-fvn7t5hbobaxjklhrqzdl4ac34-NONE"
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            print("This will copy data from sandbox (*-fvn7t5hbobaxjklhrqzdl4ac34-NONE) to main tables")
