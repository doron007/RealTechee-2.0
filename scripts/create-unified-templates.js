...
/**
 * Script to create unified notification templates and hooks
 * This script reads from setup-unified-notification-system.js and creates the records
 */
...
console.log('🚀 Creating Unified Notification Templates and Hooks');
console.log('=====================================================');

// Function to execute AWS CLI DynamoDB put-item commands
async function createTemplate(template) {
  ...
  const command = `aws dynamodb put-item --table-name "${tableName}" --item '${JSON.stringify(item)}' --region us-west-1`;
