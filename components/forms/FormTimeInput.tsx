/**
 * FormTimeInput component - Standardizes time input styling with icon
 * Eliminates duplicate time input patterns across forms
 */
...
interface FormTimeInputProps<T extends Record<string, any>> {
...
/**
 * Standardized time input with clock icon
 * Provides consistent styling and behavior across all forms
 */
export function FormTimeInput<T extends Record<string, any>>({
  register,
  errors,
  name,
  label,
